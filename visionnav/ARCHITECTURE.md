...
* **Compute Node (Edge/Laptop):** A powerful host device (carried in a backpack or running nearby) that handles all heavy lifting: YOLOE open-vocabulary object detection (doors, switches, sockets, stairs, furniture, …), Semantic SLAM mapping, A* Navigation, and Local LLM inference.
