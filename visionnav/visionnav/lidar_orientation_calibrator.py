...
def guided_walk():
    ...
    print(f"Start the brain with:  ros2 launch visionnav laptop_brain.launch.py "
...
def static_check():
    ...
    model.load_state_dict(torch.load(model_path('depth_anything_v2_metric_indoor_vits.pth'),
                                     map_location='cpu'))
